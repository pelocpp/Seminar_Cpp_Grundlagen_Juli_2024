...
namespace ConceptualExample01 {
    ...
    private:
        ...
        Singleton(const Singleton&) = delete;                  // Kopieren verbieten
        Singleton(Singleton&&) noexcept = delete;              // Kopieren verbieten
        Singleton& operator=(const Singleton&) = delete;       // a = b verbieten
        Singleton& operator=(Singleton&&) noexcept = delete;   // a = b verbieten
